...
import binnie.core.gui.minecraft.*;
		...
		this.addSelfEventHandler(new EventMouse.Down.Handler() {
			...
			public void onEvent(final EventMouse.Down event) {
				...
				if (playerController != null) {
					...
					playerController.windowClick(windowId, slotNumber, button, clone ? ClickType.CLONE : GuiScreen.isShiftKeyDown() ? ClickType.QUICK_MOVE : ClickType.PICKUP, mc.thePlayer);
				}
			}
		});
	}
