...
public class AABBModelBaker implements IModelBaker {
	...
	public void setRenderBounds(double d, double e, double f, double g, double h, double i) {
		this.setRenderBounds(new AxisAlignedBB(d, e, f, g, h, i));
	}
	...
	@Override
	public void addBlockModel(@Nonnull Block block, @Nonnull AxisAlignedBB renderBounds, @Nullable BlockPos pos, @Nonnull TextureAtlasSprite[] sprites, int colorIndex) {
	...
	@Override
	public void addBlockModel(@Nonnull Block block, @Nonnull AxisAlignedBB renderBounds, @Nullable BlockPos pos, @Nonnull TextureAtlasSprite sprite, int colorIndex) {
		addBlockModel(block, renderBounds, pos, new TextureAtlasSprite[]{sprite, sprite, sprite, sprite, sprite, sprite}, colorIndex);
	...
	private static class BoundModelBakerFace extends ModelBakerFace {
		...
		public BoundModelBakerFace(EnumFacing face, int colorIndex, TextureAtlasSprite sprite, AxisAlignedBB modelBounds) {
			super(face, colorIndex, POS_TO, POS_FROM, UVS,  sprite);
			this.modelBounds = modelBounds;
		}
	}
}
