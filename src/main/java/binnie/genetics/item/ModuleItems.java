...
public class ModuleItems implements IInitializable {
	...
	public void postInit() {
		...
		RecipeManagers.carpenterManager.addRecipe(100, Binnie.LIQUID.getFluidStack(ManagerLiquid.WATER, 2000), null,
		...
		GameRegistry.addShapedRecipe(new ItemStack(analyst),
			...
			"cac",
			" d ",
			'c', GeneticsItems.IntegratedCircuit.get(itemGenetics, 1), 'a', Mods.Forestry.item("portableAlyzer"), 'd', new ItemStack(Items.DIAMOND)
		);
