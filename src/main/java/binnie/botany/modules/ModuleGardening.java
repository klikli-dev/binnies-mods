...
public class ModuleGardening extends Module {
	...
	public void postInit() {
		...
		GameRegistry.addShapelessRecipe(
				...
				Mods.Forestry.stack("fertilizerBio")
		);

		GameRegistry.addShapelessRecipe(
				BotanyItems.POWDER_FERTILISER.get(4),
				Mods.Forestry.stack("fertilizerCompound")
		);
		...
		gardening.registerFertiliser(EnumFertiliserType.ALKALINE, Mods.Forestry.stack("woodPulp"), 2);
		...
		gardening.registerFertiliser(EnumFertiliserType.NUTRIENT, Mods.Forestry.stack("fertilizerBio"), 2);
		gardening.registerFertiliser(EnumFertiliserType.NUTRIENT, Mods.Forestry.stack("fertilizerCompound"), 2);
