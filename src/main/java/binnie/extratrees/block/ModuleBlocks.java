...
import binnie.extratrees.block.wood.*;
...
public class ModuleBlocks extends Module {
	...
	public static Map<String, IBlockState> speciesToLeavesDefault = new HashMap<>();
	...
	public void preInit() {
		...
		AlleleETFruit.preInit(); //TODO: This might need to be moved
	}
	...
	public void postInit() {
		...
		for(EnumETLog log : EnumETLog.VALUES){
			...
			if (ForestryAPI.enabledPlugins.containsAll(Arrays.asList(ForestryPluginUids.FACTORY, ForestryPluginUids.APICULTURE))) {
				...
				RecipeManagers.fabricatorManager.addRecipe(null, Fluids.GLASS.getFluid(500), fireproofLogs.copy(), new Object[]{
						" # ",
						"#X#",
						" # ",
						'#', Mods.Forestry.item("refractoryWax"),
						'X', logs.copy()});
			}
		}
		...
		for (PlankType.ExtraTreePlanks plankType : PlankType.ExtraTreePlanks.VALUES) {
			...
			if (ForestryAPI.enabledPlugins.containsAll(Arrays.asList(ForestryPluginUids.FACTORY, ForestryPluginUids.APICULTURE))) {
				...
				RecipeManagers.fabricatorManager.addRecipe(null, Fluids.GLASS.getFluid(500), fireproofPlanks.copy(), new Object[]{
						"X#X",
						"#X#",
						"X#X",
						'#', Mods.Forestry.item("refractoryWax"),
	...
	public void addSqueezer(final IWoodType log, final ILiquidType liquid, final int amount, final float pulpChance) {
		...
		RecipeManagers.squeezerManager.addRecipe(10, new ItemStack[] {logStack}, liquidStack, Mods.Forestry.stack("woodPulp"), (int) (100.0f * pulpChance));
	}
