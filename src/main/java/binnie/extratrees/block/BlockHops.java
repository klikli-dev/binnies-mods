...
public class BlockHops extends BlockCrops{
	...
	@Override
	public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, @Nullable ItemStack heldItem, EnumFacing facing, float hitX, float hitY, float hitZ) {
	...
	public Item getItemDropped(IBlockState state, Random rand, int fortune) {
		if (state.getValue(HALF) == HopsHalf.UP) {
			return null; //TODO: If crash figure out what to do here in 1.10
		} else {
