...
public enum ExtraBeeBranchDefinition implements IBranchDefinition {
	BARREN("Vacapis") {
		...
		protected void setBranchProperties(IAllele[] template) {
			...
			AlleleHelper.instance.set(template, EnumBeeChromosome.FLOWER_PROVIDER, binnie.genetics.genetics.AlleleHelper.getAllele(ExtraBeesFlowers.DEAD.getUID()));
	...
	ROCKY("Monapis") {
		...
		protected void setBranchProperties(IAllele[] template) {
			...
			AlleleHelper.instance.set(template, EnumBeeChromosome.LIFESPAN, EnumAllele.Lifespan.SHORT);
			AlleleHelper.instance.set(template, EnumBeeChromosome.FLOWER_PROVIDER, binnie.genetics.genetics.AlleleHelper.getAllele(ExtraBeesFlowers.ROCK.getUID()));
		}
	},
	METALLIC("Lamminapis") {
		@Override
	...
	NUCLEAR("Levapis") {
		...
		protected void setBranchProperties(IAllele[] template) {
			...
			AlleleHelper.instance.set(template, EnumBeeChromosome.EFFECT, binnie.genetics.genetics.AlleleHelper.getAllele(ExtraBeesEffect.RADIOACTIVE.getUID()));
		}
	},
	HISTORIC("Priscapis") {
		@Override
	...
	AQUATIC("Aquapis") {
		...
		protected void setBranchProperties(IAllele[] template) {
			...
			AlleleHelper.instance.set(template, EnumBeeChromosome.HUMIDITY_TOLERANCE, EnumAllele.Tolerance.BOTH_1);
			AlleleHelper.instance.set(template, EnumBeeChromosome.FLOWER_PROVIDER, binnie.genetics.genetics.AlleleHelper.getAllele(ExtraBeesFlowers.WATER.getUID()));
			AlleleHelper.instance.set(template, EnumBeeChromosome.EFFECT, binnie.genetics.genetics.AlleleHelper.getAllele(ExtraBeesEffect.WATER.getUID()));
		}
	},
	SACCHARINE("Sacchapis") {
		@Override
		protected void setBranchProperties(IAllele[] template) {
			AlleleHelper.instance.set(template, EnumBeeChromosome.FLOWER_PROVIDER, binnie.genetics.genetics.AlleleHelper.getAllele(ExtraBeesFlowers.SUGAR.getUID()));
		}
	},
	CLASSICAL("Grecapis"){
		@Override
	...
	VOLCANIC("Irrapis") {
		...
		protected void setBranchProperties(IAllele[] template) {
			AlleleHelper.instance.set(template, EnumBeeChromosome.SPEED, EnumAllele.Speed.SLOWER);
			AlleleHelper.instance.set(template, EnumBeeChromosome.LIFESPAN, EnumAllele.Lifespan.NORMAL);
			AlleleHelper.instance.set(template, EnumBeeChromosome.EFFECT, binnie.genetics.genetics.AlleleHelper.getAllele(ExtraBeesEffect.METEOR.getUID()));
		}
	},
	VIRULENT("Virapis") {
		@Override
	...
	VISCOUS("Viscapis") {
		...
		protected void setBranchProperties(IAllele[] template) {
			...
			AlleleHelper.instance.set(template, EnumBeeChromosome.EFFECT, binnie.genetics.genetics.AlleleHelper.getAllele(ExtraBeesEffect.ECTOPLASM.getUID()));
		}
	},
	CAUSTIC("Morbapis") {
		@Override
		protected void setBranchProperties(IAllele[] template) {
			...
			AlleleHelper.instance.set(template, EnumBeeChromosome.EFFECT, binnie.genetics.genetics.AlleleHelper.getAllele(ExtraBeesEffect.ACID.getUID()));
		}
	},
	ENERGETIC("Incitapis") {
		@Override
		protected void setBranchProperties(IAllele[] template) {
			AlleleHelper.instance.set(template, EnumBeeChromosome.CAVE_DWELLING, true);
			AlleleHelper.instance.set(template, EnumBeeChromosome.FLOWER_PROVIDER, binnie.genetics.genetics.AlleleHelper.getAllele(ExtraBeesFlowers.REDSTONE.getUID()));
			AlleleHelper.instance.set(template, EnumBeeChromosome.EFFECT, binnie.genetics.genetics.AlleleHelper.getAllele(ExtraBeesEffect.LIGHTNING.getUID()));
		}
	},
	FARMING("Agriapis"),
	SHADOW("Pullapis") {
		...
		protected void setBranchProperties(IAllele[] template) {
			...
			AlleleHelper.instance.set(template, EnumBeeChromosome.SPEED, EnumAllele.Speed.SLOWER);
			AlleleHelper.instance.set(template, EnumBeeChromosome.LIFESPAN, EnumAllele.Lifespan.NORMAL);
			AlleleHelper.instance.set(template, EnumBeeChromosome.EFFECT, binnie.genetics.genetics.AlleleHelper.getAllele(ExtraBeesEffect.BLINDNESS.getUID()));
		}
	},
	PRIMARY("Primapis"),
	SECONDARY("Secapis"),
	...
	QUANTUM("Quantapis") {
		...
		protected void setBranchProperties(IAllele[] template) {
			...
			AlleleHelper.instance.set(template, EnumBeeChromosome.NEVER_SLEEPS, true);
			AlleleHelper.instance.set(template, EnumBeeChromosome.EFFECT, binnie.genetics.genetics.AlleleHelper.getAllele(ExtraBeesEffect.GRAVITY.getUID()));
		}
	},
	BOTANIA("Botaniapis") {
		@Override
		protected void setBranchProperties(IAllele[] template) {
			...
			AlleleHelper.instance.set(template, EnumBeeChromosome.LIFESPAN, EnumAllele.Lifespan.SHORT);
			AlleleHelper.instance.set(template, EnumBeeChromosome.FLOWERING, EnumAllele.Flowering.SLOW);
			AlleleHelper.instance.set(template, EnumBeeChromosome.FLOWER_PROVIDER, binnie.genetics.genetics.AlleleHelper.getAllele(ExtraBeesFlowers.MYSTICAL.getUID()));
		}
	};
